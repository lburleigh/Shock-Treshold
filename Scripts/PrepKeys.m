...
KB.Resp1 =  [KB.Left KB.One1 KB.One2]; % No shock felt or mild
KB.Resp2 =  [KB.Down KB.Two1 KB.Two2]; % Shock too strong
KB.Resp3 =  [KB.Right KB.Three1 KB.Three2]; % Proper threshold reached
